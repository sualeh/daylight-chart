...
public final class DaylightApplicationServices
{
  ...
  private static final UserPreferencesService USER_PREFERENCES_SERVICE = new UserPreferencesService();
  private static final DaylightChartReportService DAYLIGHT_CHART_REPORT_SERVICE = new DaylightChartReportService();
