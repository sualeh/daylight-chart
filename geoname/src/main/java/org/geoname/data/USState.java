...
/**
 * US State, with codes from the Federal Information Processing Standards Publication 5-2 - Codes
 * For The Identification Of The States, The District Of Columbia And The Outlying Areas Of The
 * United States, And Associated Areas.
 *
 * @author Sualeh Fatehi
 */
public final class USState implements Serializable, Comparable<USState> {

  @Serial private static final long serialVersionUID = -5807680114125246988L;
   ...
   * @param fips5_2AlphaCode FIPS 5-2 Alpha Code
   * @param fips5_2NumericCode FIPS 5-2 Numeric Code
   */
  public USState(final String name, final String fips5_2AlphaCode, final int fips5_2NumericCode) {
    this.name = name;
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + (fips5_2AlphaCode == null ? 0 : fips5_2AlphaCode.hashCode());
