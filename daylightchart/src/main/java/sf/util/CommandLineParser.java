...
public final class CommandLineParser {
   ...
   * @param <T> Option type
   */
  public abstract static class BaseOption<T> implements Option<T> {
    ...
    protected BaseOption(final char shortForm, final String longForm, final T defaultValue) {
    ...
    private void setShortForm(final char shortForm) {
      ...
      if (!Character.isLetterOrDigit(shortForm)) {
        throw new IllegalArgumentException("Illegal short form for option specified: " + shortForm);
      }
   ...
   * @param <N> Option type
   */
  public static final class NumberOption<N extends Number> extends BaseOption<N> {
     ...
     */
    public NumberOption(final char shortForm, final String longForm, final N defaultValue) {
  ...
  public static final class StringOption extends BaseOption<String> {
     ...
     * @param defaultValue Default option value.
     */
    public StringOption(final char shortForm, final String longForm, final String defaultValue) {
      super(shortForm, longForm, defaultValue);
    }
  ...
  public String[] getRemainingArgs() {
    ...
    System.arraycopy(remainingArgs, 0, remainingArgsCopy, 0, remainingArgs.length);
  ...
  /**
   * Extract the options and non-option arguments from the given list of command-line arguments. The
   * default locale is used for parsing options whose values might be locale-specific.
   *
