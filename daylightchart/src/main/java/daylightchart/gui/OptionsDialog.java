...
public class OptionsDialog extends JDialog {
  ...
  @Serial private static final long serialVersionUID = -8756602036694384557L;
   ...
   * @return Options
   */
  public static Options showOptionsDialog(final Frame mainWindow, final Options options) {
  ...
  private OptionsDialog(final Frame mainWindow, final Options options) {
    ...
    cancel = new JButton(Messages.getString("DaylightChartGui.OptionsEditor.Cancel"));
    ...
    builder
        .addLabel(Messages.getString("DaylightChartGui.OptionsEditor.LocationsSortOrder"))
        .labelFor(listLocationsSortOrder)
        .rc(1, 1)
        .add(listLocationsSortOrder)
        .rc(1, 3);

    builder
        .addLabel(Messages.getString("DaylightChartGui.OptionsEditor.TimeZoneOption"))
        .labelFor(listTimeZoneOption)
        .rc(3, 1)
        .add(listTimeZoneOption)
        .rc(3, 3);

    builder
        .addLabel(Messages.getString("DaylightChartGui.OptionsEditor.ChartOrientation"))
        .labelFor(listChartOrientation)
        .rc(5, 1)
        .add(listChartOrientation)
        .rc(5, 3);

    builder
        .addLabel(Messages.getString("DaylightChartGui.OptionsEditor.TwilightType"))
        .labelFor(listTwilightType)
        .rc(7, 1)
        .add(listTwilightType)
        .rc(7, 3);

    builder
        .addLabel(Messages.getString("DaylightChartGui.OptionsEditor.ShowLegend"))
        .labelFor(checkShowChartLegend)
        .rc(9, 1)
        .add(checkShowChartLegend)
        .rc(9, 3);
  ...
  private void setOptionsFromDialog() {
    options.setLocationsSortOrder((LocationsSortOrder) listLocationsSortOrder.getSelectedItem());
    options.setTimeZoneOption((TimeZoneOption) listTimeZoneOption.getSelectedItem());
    options.setChartOrientation((ChartOrientation) listChartOrientation.getSelectedItem());
